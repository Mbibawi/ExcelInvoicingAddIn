 ...
 * @returns {string[]}
 */
export function getArray(value: string | undefined): string[] {
  if (!value) return [];
  const array =
    value.replaceAll(', ', ',')
      .replaceAll(' ,', ',')
...
export function getUniqueValues(index: number, array: any[][]): any[] {
  if (!array) array = [];
 ...
 */
export function getInvoiceFileName(clientName: string, matters: string[], invoiceNumber: string): string {
...
export function getInvoiceNumber(date: Date): string {
...
export function getInputByIndex(inputs: HTMLInputElement[], index: number) {
...
export function throwAndAlert(message: string) {
