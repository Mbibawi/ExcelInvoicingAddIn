...
export function getUniqueValues(index, array) {
    if (!array)
        array = [];
...
class XML {
    ...
    Pr = (tag) => `${tag.replace('w:', '')}Pr`; //!we need to remove the "w:" prefix from the tag
    /**
...
;
export function getInputByIndex(inputs, index) {
...
;
export function throwAndAlert(message) {
